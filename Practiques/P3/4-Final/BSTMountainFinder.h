...
class BSTMountainFinder {
    public:
        ...
        void tallestMountain(string filename) const;
        void shortestMountain(string filename) const;
    ...
    private:
        ...
        void tallestMountain(NodeTree<Mountain>* elem, string filename) const;
        void shortestMountain(NodeTree<Mountain>* elem, string filename) const;
};
